...
export interface paths {
    ...
    "/api/v1/conversations/stats": {
         ...
         * @description Real per-status conversation counts for the app dashboard's KPI
         *     cards — same permission/org-scoping as `list_conversations_endpoint`,
         *     never a fabricated number.
         */
        get: operations["conversation_stats_endpoint_api_v1_conversations_stats_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface operations {
    ...
    conversation_stats_endpoint_api_v1_conversations_stats_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    list_tasks_endpoint_api_v1_tasks_get: {
        parameters: {
            query?: {
                status?: string | null;
            };
